...
//int main()
//{
//    std::vector<std::vector<cv::Point3f> > objpoints;     // 创建矢量以存储每个棋盘图像的三维点矢量
//
//    std::vector<std::vector<cv::Point2f> > imgpoints;     // 创建矢量以存储每个棋盘图像的二维点矢量
//
//    // 为三维点定义世界坐标系
...
//    }
//
//    std::vector<cv::String> images;     // 提取存储在给定目录中的单个图像的路径
//    std::string path = "./images/*.jpg";     // 包含棋盘图像的文件夹的路径
//
//    // 使用glob函数读取所有图像的路径
//    cv::glob(path, images);
//
...
//
//        // 如果检测到所需数量的角点，我们将细化像素坐标并将其显示在棋盘图像上   xd
//        if (success)
//        {
